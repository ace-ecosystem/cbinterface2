...
def test_print_facet_histogram():
    from io import StringIO
    from contextlib import redirect_stdout
    from cbinterface.query import print_facet_histogram
    facet_data = {}
...
def test_make_sensor_query(monkeypatch):
    ...
    from cbinterface.sensor import make_sensor_query
...
def test_print_process_info(monkeypatch):
    from cbinterface.process import print_process_info
...
def test_print_process_ancestry(monkeypatch):
    from cbinterface.process import print_ancestry
    proc = get_process(monkeypatch)
...
def test_print_process_tree(monkeypatch):
    from cbinterface.process import print_process_tree
    proc = get_process(monkeypatch)
...
def test_print_filemods(monkeypatch):
    from cbinterface.process import print_filemods
    proc = get_process(monkeypatch)
...
def test_print_netconns(monkeypatch):
    from cbinterface.process import print_netconns
    proc = get_process(monkeypatch)
...
def test_print_regmods(monkeypatch):
    from cbinterface.process import print_regmods
    proc = get_process(monkeypatch)
...
def test_print_modloads(monkeypatch):
    from cbinterface.process import print_modloads
    proc = get_process(monkeypatch)
...
def test_print_crossprocs(monkeypatch):
    from cbinterface.process import print_crossprocs
...
def test_print_children(monkeypatch):
    from cbinterface.process import print_childprocs
    proc = get_process(monkeypatch)
...
def test_process_to_dict(monkeypatch):
    from cbinterface.process import process_to_dict
    proc = get_process(monkeypatch)
    cb = proc._cb
