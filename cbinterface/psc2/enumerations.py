...
LOGGER = logging.getLogger("cbinterface.psc2.enumerations")
...
def logon_history(cb: CBCloudAPI, hostname_or_username_query) -> None:
    ...
    """
    from cbinterface.psc2.query import make_process_query
    ...
    if processes and len(processes) > 0:
        ...
        for proc in processes:
            start_time = proc.process_start_time#as_configured_timezone(proc.process_start_time, apply_time_format="%Y-%m-%d %H:%M:%S%z")
